...
╚═╝     ╚═╝╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝╚═════╝ ╚═╝
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            Md Mehadi Sarkar 
\033[1;37m Facebook:  https://www.facebook.com/profile.php?id=100090585967517
\033[1;37m Github  :      Md Mehadi Sarkar 
...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://www.facebook.com/profile.php?id=100090585967517/')
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        SSB(allkey)
...
def cutter():
    ...
    print(47*'-')
    input(f"{S} Press Enter To Back Mehadi Menu ")
    SSB(allkey)       
